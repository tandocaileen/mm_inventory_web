...
import 'package:mm_inventory_web/ui/utils/layout/tablet_layout.dart';
...
class DashboardViewTablet extends ViewModelWidget<DashboardViewModel> {
  ...
  Widget build(BuildContext context, DashboardViewModel viewModel) {
    return _DashboardViewTabletContent(viewModel: viewModel);
  }
}

class _DashboardViewTabletContent extends StatefulWidget {
  const _DashboardViewTabletContent({required this.viewModel});

  final DashboardViewModel viewModel;

  @override
  State<_DashboardViewTabletContent> createState() =>
      _DashboardViewTabletContentState();
}
